...
2. **Build and run**
   ...
   docker run -e JIRA_EMAIL='your-email@redhat.com' -e JIRA_TOKEN='your-api-token' -v $(pwd):/app redhat-ai-release-planner
   ```
...
3. Name: "Red Hat AI Products Release Planner"
